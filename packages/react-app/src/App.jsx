...
import { Home, ExampleUI, Hints, Subgraph, Flow } from './views'
...
function App(props) {
  ...
  */
  ...
  const navigation = [
    ...
    { name: 'Flow', href: '/flow', icon: ShareIcon },
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                <Switch>
                  ...
                  <Route exact path="/flow">
                    <Flow yourLocalBalance={yourLocalBalance} readContracts={readContracts} />
                  </Route>
